package com.yjjr.yjfutures.widget.dropdownmenu;
...
public class TRMenuAdapter extends RecyclerView.Adapter<TRMenuAdapter.TRMViewHolder> {
    ...
    public void onBindViewHolder(TRMViewHolder holder, int position) {
      ...
      /*  if (position == 0){
            holder.container.setBackgroundDrawable(addStateDrawable(mContext, -1, com.zaaach.toprightmenu.R.drawable.trm_popup_top_pressed));
        }else if (position == menuItemList.size() - 1){
            holder.container.setBackgroundDrawable(addStateDrawable(mContext, -1, com.zaaach.toprightmenu.R.drawable.trm_popup_bottom_pressed));
        }else {
            holder.container.setBackgroundDrawable(addStateDrawable(mContext, -1, com.zaaach.toprightmenu.R.drawable.trm_popup_middle_pressed));
        }*/
